...
class DepositSeeder extends Seeder
{
    ...
    public function run(): void
    {
        if (Core::packageExists('Business')) {
            ...
            foreach ($this->secondThreeLevelServiceTypeData() as $entry) {
