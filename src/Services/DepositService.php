...
class DepositService
{
    ...
    public function create(array $inputs = []): BaseModel
    {
        ...
        try {
            ...
            match ($inputs['order_data']['order_type']) {
                OrderType::InteracDeposit => InteracTransferReceived::dispatch($deposit),
                OrderType::CardDeposit => CardDepositReceived::dispatch($deposit),
                OrderType::BankDeposit => BankDepositReceived::dispatch($deposit),
                default => logger('Unknown Deposit Type', $inputs)
            };
