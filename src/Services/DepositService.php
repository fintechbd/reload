...
class DepositService
{
    ...
    public function depositAccept($data): array
    {
        ...
        $orderDetailStoreForMaster->order_detail_amount = -$orderDetailStoreForMaster->amount;
        $orderDetailStoreForMaster->converted_amount = -$orderDetailStoreForMaster->converted_amount;
        ...
        $orderDetailStoreForChargeForMaster->order_detail_amount = calculate_flat_percent($data->amount, $serviceStatData['charge']);
        ...
        $orderDetailStoreForDiscountForMaster->order_detail_amount = -calculate_flat_percent($data->amount, $serviceStatData['discount']);
